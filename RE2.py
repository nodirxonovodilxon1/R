...
from aiogram.types import ReplyKeyboardMarkup, KeyboardButton, ReplyKeyboardRemove, ChatMemberUpdated
...
# Link yuborish va xotiradan o‘chirish
async def send_group_link(message):
...
# ADMINga ma'lumot jo‘natish
async def send_admin_info(message):
...
async def main():
    ...
    print("✅ Bot ishladi!")  # Bu to'g'ri joyda
